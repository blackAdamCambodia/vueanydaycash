<template>
    <div>
        <OtherHeader/> 
         <!-- Definitions main part start -->
    <main class="main-content main-content--short-form">
      <div class="container">
        <div class="row">
          <div class="col col--text">
            <div class="content-details"> 
                ...
                <p> 
                    <strong>APR or Annual Percentage Rate</strong>
                ...
                <p> 
                    ...
                    - This is a legal proceeding in America's Federal Court which in entered into by a borrower. This is often someone who is not able to pay back his debts which allows for them to negotiate some form of partial payment or the selling of a borrower's assets. Bankruptcy information will stay on the credit history of a person for up to a decade. </p> <p> <strong>Budget</strong> - A plan or method used for spending management and for saving money. </p> <p> <strong>Caps</strong> - The established limit of an amount's interest rate which can be increased to an adjustable rate mortgage loan. </p> <p> <strong>Cash advance</strong> - This refers to a source of cash which can be taken in the case of emergencies. This is for people who are employed but may not have access to other sources of credit. This is meant to bridge the financial gap in between now and the next pay day. The interest is charged from the date it is advanced. 
                </p> 
                <p> 
                    <strong>Charge off</strong> 
                    - This is a credit card debt or loan which is written off as being uncollectible from a borrower. This at times is the case when the loan has been sold or given the debt to some collection agency. This debt remains collectable. </p> <p> <strong>Checking account</strong> - The money which is kept in savings or a bank for safekeeping. This money can be withdrawn easily by simply writing out a check or using an ATM machine. </p> <p> <strong>Security or Collateral</strong> - Often an asset which is pledged in order to assure repayment of debt. </p> <p> <strong>Compound interest</strong> - Interest which is computed on the loan's balance, the balance will include all interest which is unpaid. </p> <p> <strong>Co-signer</strong> - An individual who willfully signs a loan agreement with the borrower and partly assumes responsibility of repayment of a loan. </p> <p> <strong>Credit</strong> - The promise to pay the amount at a later date for services or goods availed presently. 
                </p>
                <p> 
                ...
                <p> 
                    ...
                    - An organization that works to compile the credit histories of would be borrowers and also provides these reports to lenders and lending partners. These reports are used by lenders and lending partners for making decisions. Experian, TransUnion and Equifax are the largest credit reporting agencies in America. </p> <p> <strong>Credit card</strong> - This is a card issued by the bank in order to make payments for purchases. The outstanding balance is subject to interest. </p> <p> <strong>Credit counseling</strong> - A type of counseling which is provided by organizations aimed at helping consumers with ways to repair their credit so as to get their financial affairs back on track. 
                </p> 
                <p> 
                ...
                <p> 
                    ...
                    - This is also often referred to personal line of credit and is the maximum amount a person can get against his or her account. Once the credit line has been repaid the person can then re-borrow against this account. </p> <p> <strong>Credit report </strong>- This is a report which is actually the history of a person's debt repayment, outstanding debts, bankruptcies and late payments. It will also have his or her bankruptcies. 
                </p>
                <p> 
                ...
                </p> <p><strong>Debt</strong> - The amount which is owed to a lender or lending partner.
                </p> 
                <p> 
                    <strong>Debt Consolidation</strong> 
                    - This refers to a strategy which is at times used by people to improve their debt management issues. Instead of opting to pay several bills every month a consumer will just pay his debt with one bill to one financial institution. </p> <p><strong>Default</strong> - The failure to pay back a loan or meet the terms the loan agreement.</p> <p><strong>Delinquency</strong> - Failing to pay on time.</p> <p> <strong>Direct Deposit </strong>- This is an electronic funds transfer directly to a bank account, so paper check is not needed. 
                </p>
                <p> 
                    <strong>Equal Credit Opportunity Act</strong> 
                ...
                <p> 
                    ...
                    - Often referred to as an electronic signature this requires a software which binds your signature or some other mark to a document. The E-sign bill was passed by the government in June 2000 which legalizes this signature. </p> <p> <strong>The Fair Credit Reporting Act</strong> - This is a federal law which gives borrowers the right to lean exactly what info credit reporting agencies currently have on them, it also enables them to dispute incorrect data. </p> <p> <strong>FDIC or Federal Deposit Insurance Corporation</strong> - Usually a federal agency which insures a consumer's deposit in their savings and for a loan of up to $100,000 for every account. These deposits will include savings and checking accounts and also deposit certificates. 
                </p> 
                <p>
                ...
                <p> 
                    <strong>A fixed interest rate</strong> 
                ...
                <p> 
                    <strong>
                    Lender or Lending Partner</strong> - A business or a person who lends or even offers loans to people. 
                </p> 
                <p>
                    <strong>Liable</strong> 
                    - to have legal responsibility.</p> <p> <strong>Lien</strong> - When a creditor lays claim to a piece of property to ensure his debt is paid off. 
                </p> 
                <p> 
                    <strong>Loan</strong> 
                ...
                <p> 
                    <strong> Truth in Lending Act</strong> 
